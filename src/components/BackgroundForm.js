    ...
    <ol>
      ...
      <li>
        <div
          ...
          className={errors.earningsDesiredData ? "field has-error" : "field"}
        >
          <label htmlFor="earningsDesiredData">
            Suppose you are asked to predict the total annual earnings (in U.S.
      ...
      <li>
        <label htmlFor="satisfactionDesiredData">
          Suppose you are asked to predict the overall life satisfaction of
          another person. What 3 things would you want to know about them to
        ...
        {errors.satisfactionDesiredData && (
          <span className="help-block">{errors.satisfactionDesiredData}</span>
        )}
      </li>
    </ol>
    <div>
